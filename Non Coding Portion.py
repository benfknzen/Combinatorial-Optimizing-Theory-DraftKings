...
# Non Coding Portion
#
# User downloads csv file off Draftkings and puts into appropriate folder
# Update fighter_data.csv
# Run this program
# Upload csv back into Draftkings
# Loop back to 1 till filthy rich
#
# main.py
#
# Execution
...
# Filter data_set with filter_data_set.py in optimal ways
